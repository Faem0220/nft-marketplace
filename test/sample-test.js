...
describe("NFTMarket", function () {
  it("Should create and execute market sales", async function () {
    ...
    await market.connect(buyerAddress).createMarketSale(nftContractAddress,4, {value:auctionPrice})
    ...
    let items2 = await market.fetchAllMarketItems()
